...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "jVw5A63JO4BE4qnqbusINA";
    private static final String CONSUMER_SECRET = "Eg-R47ubbN9Mqo7tPZsooikqh7o";
    private static final String TOKEN = "dTdpuIjqak09Dvi_j1egnku5vZ8IVDhF";
    private static final String TOKEN_SECRET = "w2KH_lduMtnp7WNjmKLc8pI4SZQ";
